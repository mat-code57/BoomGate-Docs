...
- `PRODUCT_TAGS` - PRODUCT, TAGS, TIME, ADDRESS, SHIPPING, REDUCTION, BILLING
...
- `PRODUCTS_WITH_*_TOTAL_*` aggregates - Multiple types (use `list_properties` to check availability)
